...
class PaymentsController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update', 'late'),
				'users'=>array('@'),
			),
	...
	public function actionLate(){
		...
		$criteria->condition = 'next_payment_date is not null';
		$criteria->condition .= ' and next_payment_date < now() ';
		$criteria->order = 'next_payment_date asc';
		
		$dataProvider = new CActiveDataProvider( 'Members', 
				array('criteria'=>$criteria,
		));
		$this->render('late', array(
			'dataProvider'=>$dataProvider,
		));
	}
}
